      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <div className="flex items-center">
              <svg width="32" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="rounded-full mr-2">
              ...
              <span className="text-lg font-semibold font-sans">CommunionHub</span>
            </div>
            <p className="text-sm text-gray-400 mt-2 font-sans">Connecting people across faiths & interests.</p>
          </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between">
          ...
          <div className="mt-4 md:mt-0 flex space-x-6">
            ...
            <a href="#" className="text-sm text-gray-400 hover:text-white transition-colors font-sans">Contact Us</a>
          </div>
        </div>
      </div>
    </footer>
